...
import com.hyphenate.chatuidemo.redpacket.ChatRowADRedPacket;
import com.hyphenate.chatuidemo.redpacket.ChatRowRandomPacket;
import com.hyphenate.chatuidemo.redpacket.ChatRowRedPacket;
import com.hyphenate.chatuidemo.redpacket.ChatRowRedPacketAck;
import com.hyphenate.chatuidemo.redpacket.RedPacketUtil;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    private static final int MESSAGE_TYPE_RECV_AD = 11;
    private static final int MESSAGE_TYPE_SEND_AD = 12;
    private static final int MESSAGE_TYPE_RECV_RANDOM = 13;
    private static final int MESSAGE_TYPE_SEND_RANDOM = 14;
    private static final int ITEM_RED_PACKET = 16;
    private static final int ITEM_TRANSFER_PACKET = 17;
    private static final int ITEM_RANDOM_PACKET = 18;
    ...
    protected void registerExtendMenuItem() {
        ...
        //red packet code : 小额随机
        if (chatType == Constant.CHATTYPE_SINGLE) {
            inputMenu.registerExtendMenuItem(R.string.attach_random_packet, R.drawable.em_chat_red_packet_selector, ITEM_RANDOM_PACKET, extendMenuItemClickListener);
        }
        //end of red packet code
    }
    ...
    public boolean onExtendMenuItemClick(int itemId, View view) {
        switch (itemId) {
            ...
            case ITEM_RANDOM_PACKET:
                RedPacketUtil.startRedPacket(getActivity(), RPConstant.RP_ITEM_TYPE_RANDOM, toChatUsername, new RPSendPacketCallback() {
                    @Override
                    public void onGenerateRedPacketId(String redPacketId) {
    ...
    private final class CustomChatRowProvider implements EaseCustomChatRowProvider {
        ...
        public int getCustomChatRowType(EMMessage message) {
            if (message.getType() == EMMessage.Type.TXT) {
                ...
                //red packet code : 红包消息、红包回执消息的chatrow type
                ...
                } else if (RedPacketUtil.isADRedPacket(message)) {//广告红包
                    return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_AD : MESSAGE_TYPE_SEND_AD;
        ...
        public EaseChatRow getCustomChatRow(EMMessage message, int position, BaseAdapter adapter) {
            if (message.getType() == EMMessage.Type.TXT) {
                ...
                //red packet code : 红包消息、红包回执消息以及转账消息的chat row
                    ...
                    return new ChatRowADRedPacket(getActivity(), message, position, adapter);
                } else if (RedPacketUtil.isRandomRedPacket(message)) {//小额随机红包
