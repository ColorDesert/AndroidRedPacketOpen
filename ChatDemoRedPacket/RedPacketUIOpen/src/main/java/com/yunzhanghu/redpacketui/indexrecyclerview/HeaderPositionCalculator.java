...
class HeaderPositionCalculator {
     ...
     */
    boolean hasNewHeader(int position, boolean isReverseLayout) {
    ...
    void initHeaderBounds(Rect bounds, RecyclerView recyclerView, View header, View firstView, boolean firstHeader) {
