...
public class CharacterParser {
    ...
    private static int[] pyKey = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    private static String[] pyValue = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    private static int[] extraKey = new int[]{-10078, -10076, -10071, -10064, -10049,
            -10041, -10015, -10005, -9992, -9991,
            -9986, -9823, -9822, -9818, -9784,
            -9764, -9753, -9564, -9509, -9485,
            -9479, -9477, -9310, -9309, -9302,
            -9300, -9299, -9293, -9286, -9280,
            -9017, -8969, -8777, -8706, -8503,
            -7853, -7761, -7465, -7220, -7206,
            -7205, -6749, -6745, -6731, -6708,
            -6705, -6205, -6191, -5965, -5905,
            -5894, -5456, -5437, -5429, -5428,
            -5414, -5128, -4945, -4938, -4888,
            -4111, -4102, -3652, -3613, -3417,
            -3133, -3122, -2877, -2849, -2848,
            -2396, -2364, -692};

    private static String[] extraValue = new String[]{"qi", "gai", "cheng", "bi", "mie",
            "she", "kuai", "zhang", "kang", "zhu",
            "gou", "tong", "tuo", "er", "yan",
            "she", "kui", "ming", "qiao", "wei",
            "wu", "bing", "tai", "jia", "li",
            "qao", "xi", "yan", "feng", "he",
            "rui", "xun", "shen", "lin", "xi",
            "qie", "cen", "yu", "lv", "que",
            "kan", "dan", "pu", "mi", "pang",
            "qiu", "gou", "mou", "qu", "luan",
            "chu", "zang", "zan", "chao", "yan",
            "bi", "teng", "shu", "yu", "hu",
            "zhong", "ji", "dou", "xu", "zhuan",
            "zhu", "da", "qiu", "ji", "yi",
            "zi", "qu", "qu"
    };

    private static final int maxAscii = -10247;//GB23112最大ASCII码

    private static final int minAscii = -20319;//GB2312最小ASCII码

    private static final int maxExtraAscii = -692;//扩展常用姓氏最大ASCII码

    private static final int minExtraAscii = -10078;//扩展常用姓氏最小ASCII码
    ...
    private String convert(String str) {
        ...
        } else if (ascii >= minAscii && ascii <= maxAscii) {
            for (int i = (pyKey.length - 1); i >= 0; i--) {
                if (pyKey[i] <= ascii) {
                    return pyValue[i];
                }
            }
        } else if (ascii >= minExtraAscii && ascii <= maxExtraAscii) {
            int i;
            for (i = 0; i < extraKey.length; i++) {
                if (extraKey[i] == ascii) {
                    return extraValue[i];
                }
            }
